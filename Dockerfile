...
RUN yarn remove @semantic-release/exec @tsconfig/node16 @types/node eslint-plugin-prettier prettier prettier-config-xo semantic-release semantic-release-docker ts-node type-fest typescript xo \
